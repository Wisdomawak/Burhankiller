...
##########################################################
# AUTHOR : WISDOM AWAK #
# CONTAK : 09066270953 [WHATSAPP]                       #
# GITHUB : HTTPS://GITHUB.COM/WISDOM AWAK                   #
##########################################################
#   OPEN SOURCE YA NGAB JANGAN DI PERJUAL BELIKAN OKH    #
##########################################################
#   JIKA ADA EROR TOLONG WHATSAPP SAYA : 09066270953    #
##########################################################
...
\033[0;35m   /  |/  /  _/ |/ /  _/   • CODE BY WISDOM X AWAK •
\033[0;33m  / /|_/ // //    // / • HTTPS://GITHUB.COM/WISDOM AWAK •
 ...
 #M,P))
	...
	print("%s [!] Isi dengan benar "%(O));exit()
        ...
        if _hay_tayo_hay_nano_ in(""):
        	...
        	os.system("xdg-open https://www.facebook.com/groups/31937689")
                _kem_ = raw_input("\n \033[0;36m[\033[0;35m+\033[0;36m]\033[0;00m [ ENTER ]")
                mmmasuk() 
        elif _hay_tayo_hay_nano_ in("2","02"):
                os.system("xdg-open https://chat.whatsapp.com/F145IYqFwcXH0")
                _kem_ = raw_input("\n \033[0;36m[\033[0;35m+\033[0;36m]\033[0;00m [ ENTER ]")
                mmmasuk()
...
#    print (' Waktu : %s'%(datetime.now().strftime('%H:%M:%S'))
    ...
    print(" \033[0;36m[\033[0;35m+\033[0;36m]\033[0;00m Username  : WISDOM "%(nama))
...
def masuk():
    ...
    Wisdom("\033[0;36m[\033[0;35m2\033[0;36m]\033[0;00m Instagram")
    Wisdom("\033[0;36m[\033[0;35m3\033[0;36m]\033[0;00m Donasi")
    Wisdom("\033[0;36m[\033[0;35m4\033[0;36m]\033[0;00m Tutor Dump Token")
    Wisdom("\033[0;36m[\033[0;35m5\033[0;36m]\033[0;00m preliminary ]\033[0;33m[ \033[0;35mPENDAHULUAN PENGGUNA \033[0;33m]")
    Wisdom("\033[0;36m[\033[0;35m6\033[0;36m]\033[0;00m DUMP USER-AGENT")
    mrWizzysxxxkxnanoxxz = raw_input("\n\033[0;36m[\033[0;35m+\033[0;36m]\033[0;00m Input : ")
...
def gobloklu():
   ...
   jeeck("\033[0;36m[\033[0;35m+\033[0;36m]\033[0;00m         ( Fb : https://www.facebook.com/Wisdomawak")
   jeeck("\033[0;36m[\033[0;35m+\033[0;36m]\033[0;00m         ( Em : Wisdomawak65@Gmail.com")
...
def pendahuluanxnano():
   ...
   jeeck("\033[0;36m[\033[0;35m7\033[0;36m]\033[0;00m WHATSAP : 09066270953")
...
#                            
                            ...
                            jeeck(" \033[0;36m[\033[0;35m+\033[0;36m]\033[0;00m Isi dengan benar");_Wisdom_X_Awak_()
                    ...
                    Wisdom(" \033[0;36m[\033[0;35m4\033[0;36m]\033[0;00m Mobile [ Supper Sellow [ LEBIH BANYAK HASIL RECOMENDED V3 ]]")
                    _Wisdom_X_Awak_(pwx.split(','))
                    break
        elif __Wisdom__ganz__X__Fuck__boy__ in ('O', 'o'):
            jeeck("\n \033[0;36m[\033[0;35m+\033[0;36m]\033[0;00m Pilih sesuka hati kalian")
            print(" \033[0;36m[\033[0;35m1\033[0;36m]\033[0;00m B-Api [ FAST CRACK ]")
            print(" \033[0;36m[\033[0;35m2\033[0;36m]\033[0;00m Mbasic [ Selow[ RECOMENDED V1 ]]")
            print(" \033[0;36m[\033[0;35m3\033[0;36m]\033[0;00m Free fb[ Selow[ RECOMENDED V2 ]]")
